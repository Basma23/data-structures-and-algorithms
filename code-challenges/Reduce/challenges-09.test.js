...
const countNumberOfElements = (arr) => {
  // Solution code here...
  let lengthOfArray = arr.reduce((value) => {
    value = value + 1;
    return value;
}, 0);
...
const returnNames = (arr) => {
  // Solution code here...
  let newArr = arr.reduce((accumulator,obj) =>{
...
const reversedString = (str) => {
  // Solution code here...
  let convertToString = str.split('');
  let back = convertToString.reduce((acc, value) => {
      return value + acc;
  }, '');
  return back;
};
